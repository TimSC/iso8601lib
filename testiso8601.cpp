...
void Iso8601TestCases(std::vector<std::string> &testStrs, std::vector<double> &testTimestamps)
{
	...
	testStrs.push_back("2009123");
	testTimestamps.push_back(1241308800);

	testStrs.push_back("2009-05");
	testTimestamps.push_back(1241136000);

	testStrs.push_back("2009-123");
	testTimestamps.push_back(1241308800);

	testStrs.push_back("2009-222");
	testTimestamps.push_back(1249862400);

	testStrs.push_back("2009-001");
	testTimestamps.push_back(1230768000);

	testStrs.push_back("2009-W01-1");
	testTimestamps.push_back(1230508800);

	testStrs.push_back("2009-W51-1");
	testTimestamps.push_back(1260748800);

	//I don't think this is valid ISO 8601?
	//testStrs.push_back("2009-W511");
	//testTimestamps.push_back(1260748800);

	testStrs.push_back("2009-W33");
	testTimestamps.push_back(1249862400);

	testStrs.push_back("2009W511");
	testTimestamps.push_back(1260748800);
